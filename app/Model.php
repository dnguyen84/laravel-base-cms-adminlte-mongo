...
class Model extends Eloquent
{
    ...
    /**
     * Add whereFullText search method for model
     * @link(https://github.com/jenssegers/laravel-mongodb/issues/408)
     * @example User::whereFullText('hello')
     */
     ...
     */
    public static function fromFillable($merge = [])
    {
        $instance = new static;
