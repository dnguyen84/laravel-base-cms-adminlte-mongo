...
class Filesystem extends Model
{
    ...
    protected $collection = 'sys.filesystem';
    ...
    protected $fillable = [
        ...
        'guid',     // string   Upload file of object id
        'task',     // string   File from task: upload | download
        'kind',     // string   Upload type: product, school, ...
