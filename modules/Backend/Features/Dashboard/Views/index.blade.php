...
<section class="content section-report">
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <a href="{{ route('admin.index') }}" class="small-box-footer">@lang('messages.detail') <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            <!-- small box -->
        ...
        <section class="col-lg-12 connectedSortable">
            ...
            <div class="box box-info">
                ...
                <!-- <div class="box-footer clearfix"> -->
                    <!-- <a href="{{ route('admin.index') }}" class="btn btn-sm btn-info btn-flat pull-left">Xem thêm</a> -->
                    <!-- <a href="{{ route('admin.index') }}" class="btn btn-sm btn-default btn-flat pull-right">Xem thêm</a> -->
                <!-- </div> -->
